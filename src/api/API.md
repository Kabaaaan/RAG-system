...
## 3. Статус промежуточного хранилища
...
## 4. Добавление типа ресурса для RAG
...
## 5. Получение списка типов ресурсов
...
## 6. Добавление типа рекомендации
...
## 7. Получение списка типов рекомендаций
...
## 8. Индексация ресурса в промежуточном хранилище
### `POST /staging-area`
...
## 9. Получение ресурса из промежуточного хранилища
...
## 10. Импорт email из Mautic в промежуточное хранилище
...
## 11. Полное обновление векторной БД
...
## 13. Статус ресурса в векторной БД
...
## 15. Получение статуса рекомендации
...
## 16. Получение рекомендации пользователя
...
| Параметр | Тип | Обязательный | Описание |
|----------|-----|--------------|----------|
| id       | int | да           | Идентификатор типа рекомендации |
...
## 19. Получение цифровых следов пользователя
...
## 20. Получение данных о задачах генерации
